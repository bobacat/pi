...
try:
    ...
    draw.text((x_day_str, 180),day_str, font=font_day_str, fill = 255)  # Day string calender text
    draw.text((x_day_num, 180),day_number, font=font_day, fill = 255)  # Day number string text
